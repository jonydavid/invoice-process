    ...
    <div className="flex min-h-screen">
      ...
      <div className="flex flex-col h-screen p-3 w-60 dark:bg-gray-900 dark:text-gray-100">
        ...
        <div className="flex items-center p-2 mt-12 space-x-4 justify-self-end">
          ...
          <div>
            <h2 className="text-lg font-semibold">Jonattan Miranda</h2>
          </div>
        </div>
      </div>
          ...
          <div className="flex items-center justify-center">
            <div className="relative flex flex-col mt-6 text-gray-700 bg-white shadow-md bg-clip-border rounded-xl w-11/12">
              <div className="p-6">
                ...
                <input className="block w-full p-2 text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none" aria-describedby="file_input_help" id="file_input" type="file" />
